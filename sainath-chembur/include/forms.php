...
<form id="_idmyform" name=" <?php  echo $row['formname']; ?>" action="test.php" method="post" accept-charset="utf-8" enctype="multipart/form-data"
...
<!-- <button id="myBtn" type="submit" name="myBtn" class="btn btn-info micro-form-btn mt-2 effetMoveGradient"  value="Enquiry Now">Enquiry Now</button> -->
<input id="myBtn" name="myBtn" class="btn btn-info micro-form-btn mt-2 effetMoveGradient" type="submit" value="Enquiry Now">
